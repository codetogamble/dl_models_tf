...
conv3 = Layers.Conv2D(7,5,2,padding="same",activation='relu',use_bias=True)(conv2)
conv4 = Layers.Conv2D(8,5,2,padding="same",activation='relu',use_bias=True)(conv3)
conv5 = Layers.Conv2D(12,7,2,padding="same",activation='relu',use_bias=True)(conv4)
...
deconv1 = Layers.Conv2DTranspose(8,7,2,padding="same",activation='relu',use_bias=True)(conv5)
deconv2 = Layers.Conv2DTranspose(6,5,2,padding="same",activation='relu',use_bias=True)(deconv1)
deconv3 = Layers.Conv2DTranspose(4,5,2,padding="same",activation='relu',use_bias=True)(deconv2)
deconv4 = Layers.Conv2DTranspose(3,3,2,padding="same",activation='relu',use_bias=True)(deconv3)
