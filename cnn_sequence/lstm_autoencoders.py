...
lstm_4 = Layers.LSTM(32,activation='relu',input_shape=(batch_size,32),return_sequences=True)(lstm_3)
lstm_5 = Layers.LSTM(64, activation='relu', return_sequences=True)(lstm_4)
# Decoder
fc3 = Layers.TimeDistributed(Layers.Dense(625,activation='relu'))(lstm_5)
