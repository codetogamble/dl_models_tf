...
while(True):
	...
	if ret == True:
		...
		out_300 = cv2.resize(out[50:350,50:350],(400,400))
		output = sess.run(layer_fc2,feed_dict={input_image:[out/255,out_300/255]})
		print(output)
		
		out_img = cv2.cvtColor(out,cv2.COLOR_GRAY2BGR)
		if output[0][1] < output[0][0]:
			print("POSITIVE")
			cv2.rectangle(out_img,(0,0),(out.shape[0],10),(0,0,255),-1)
		else:
			print("NEGATIGVE")
			cv2.rectangle(out_img,(0,0),(out.shape[0],10),(0,255,0),-1)
